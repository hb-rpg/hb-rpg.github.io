...
export const cultistTag = { Class: "Arcane", Job: "Cultist" };
export const cultistWholeTag = backgroundTagWithProfession(cultistTag);
export const barbarianTag = { Class: "Martial", Job: "Barbarian" };
export const barbarianWholeTag = backgroundTagWithProfession(barbarianTag);
export const scholarTag = { Class: "Performer & Scholarly", Job: "Scholar" };
export const warlockTag = { Class: "Arcane", Job: "Warlock" };
export const warlockWholeTag = backgroundTagWithProfession(warlockTag);
export const scoundrelTag = { Class: "Rogue", Job: "Scoundrel" };
