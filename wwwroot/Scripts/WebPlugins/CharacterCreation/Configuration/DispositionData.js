export const Races = ["Human", "Orc", "Elf", "Halfling", "Dwarf", "Ixian"];
export const Moralities = ["Good", "Neutral", "Evil"];
export const Order = ["Lawful", "Neutral", "Chaotic"];
export const DevelopmentalEnvironments = ['Nobility', 'Clergy', 'Commoner'];
export const RaceDefaultExplanation = {
    ...
    Description: "Choose one of six Ancestries — Dwarf, Elf, Halfling, Human, Ixian, or Orc — to define your character's species and cultural heritage. Your Ancestry reflects not just your biology but your upbringing, culture, and the world that shaped you before adventure called, and so will have a large impact on your character's edges, spells, skills, languages, gear, and more! See the rulebook for more details."
};
...
export const DevelopmentalEnvironmentDescriptions = [
    {
        Tags: {
