...
import { columnHeaderRow, dataRow, emptyRows, makeSection } from '../../../Framework/PDFs/Helpers.js';
import { Item } from '../Contracts/TaggedData.js';
import type { Content } from '../../../Framework/PDFs/Types.js';
...
const isCoinTrinket = (item: Item) => item.Name.includes(COIN_TRINKET_MARKER)
