import { DispositionType, EntanglementOrganizationTypesEnum, JobSubset, JobSubsetEnum, JobType, ProfessionType } from "../Contracts/StringTypes.js";
import { StoryModel } from "../Contracts/TaggedData.js";
import { EntanglementAffect, RelationshipModel, RollReservations } from "../Contracts/Entanglements.js";
import { Utility } from "../../../WebCore/Utility.js";


export namespace CareerData {
    const generateRelationships = (Destination : EntanglementOrganizationTypesEnum, RollReservation : RollReservations, chosenName? : string) : EntanglementAffect  =>{
