...
import { ChoiceGroup, OverrideChoiceLambda, SelectionPackage, TaggedCharacterData } from "../Contracts/TaggedData.js";
...
export namespace ReligionData {
    ...
    export const Tubal = new Deity(
        {name:"Tubal", id: Utility.idGenerator.newID()},
        "Tubal represents fire, metalworking, and crafts in general. Tubal is the dour and serious sibling of Juba. In religious tradition, Tubal forged the magic chains that were used to imprison Ghoelb. Tubal is especially revered by artisans, crafters, smiths, and dwarves. For Theurgic Spellcasters, Tubal provides aid to followers casting Evocation spells (magic that creates and manipulates energy and elements), especially those related to light, heat, and fire.",
        resolveDeityPath("Tubal hammer.jpg"), resolveDeityPath("Tubal hammer rune.jpg")
    );

    export const Weut = new Deity(
        {name:"Weut", id: Utility.idGenerator.newID()},
        "Weut represents creativity, nature, and creation. Weut is an ancient, primeval entity who created the other gods to aid in the imprisonment of Ghoelb so that creation could begin. Taking the form of an owl, Weut created water from the void then drew up land and mountains from the calm seas. They then nested on the highest mountain to oversee the remainder of creation carried out by the other gods. Weut is especially revered by artisans, high elves, and spellcasters. For Theurgic Spellcasters, Weut provides aid to followers casting Transmutation spells (magic that changes the properties of a being, energy, or substances).",
        resolveDeityPath("Weut owl.jpg"), resolveDeityPath("Weut creation rune.jpg")
    );

    export const Abala = new Deity(
        {name:"Abala", id: Utility.idGenerator.newID()},
        "Abala represents agriculture, livestock, farming, harvest, home, hearth, and tamed nature. They are typically seen as a male counterpart to Asherah and some even believe they are one spirit. Abala is especially honored by farmers, husbands, and halflings. Abala restrained Ghoelb's right hand as it was shackled by Tubal. For Theurgic Spellcasters, Abala provides aid to followers casting Evocation spells (magic that creates and manipulates energy and elements).",
        resolveDeityPath("Abala wheat head.jpg"), resolveDeityPath("Abala wheat rune.jpg")
    );

    export const Asherah = new Deity(
        {name:"Asherah", id: Utility.idGenerator.newID()},
        "Asherah represents fertility, birth, rain, springs, and untamed nature. Asherah is considered by many as a female aspect of Abala. Asherah is especially honored by wives, herders, druids, hunters, elves, halflings, and orcs. Asherah restrained Ghoelb's left hand as it was shackled by Tubal. For Theurgic Spellcasters, Asherah provides aid to followers casting Abjuration spells (magic that is used for protection from forces or supernatural beings).",
        resolveDeityPath("Asherah tree.jpg"), resolveDeityPath("Asherah tree rune.jpg")
    );

    export const Kain = new Deity(
        {name:"Kain", id: Utility.idGenerator.newID()},
        "Kain represents battle, conflict, and sorrow. Kain is also invoked by oathbreakers to protect them from consequences. In some religious traditions, Kain was created by Ghoelb but betrayed them in order to protect the world made by Weut and the other gods. When Kain fought Ghoelb to subdue them, their sword shattered because of the betrayal. Kain is especially honored by warriors, dwarves, orcs, and Ixians. For Theurgic Spellcasters, Kain provides aid to followers casting Abjuration spells (magic that is used for protection from forces or supernatural beings).",
    ...
    export const possibleDeities = [
        Enoch, Gestas, Ghoelb, Hiram, Juba, Moloch, Tubal, Weut, Abala, Asherah, Kain
    ];
    ...
    const jobOverrideLambda : OverrideChoiceLambda<Deity> = (taggedChoiceBeingOverridden, characterData)=>{
        
        const mappedDeity = jobOverride.get(characterData.JobSubset())
        if (mappedDeity) {
